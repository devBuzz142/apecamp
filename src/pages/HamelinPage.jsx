  ...
  return (
    <Page>
      <PageLeftSection>
        <h1>Hamelin</h1>
        <div>
          ChatGPT의 등장에 인공지능을 연출한 공연에 활용해보기로 하였습니다.
          이에 이미지 생성 인공지능인 DALL-E를 활용하여 이미지를 생성하였습니다.
          창작자들과 극에서 주요하게 사용되는 개념어를 추출하였습니다.
          탁상작업의 과정에서 자주 사용되는 단어나, 디자이너들이 작업을 함에
          있어 핵심으로 여긴 개념어를 수합하였습니다. 이를 통해 얻은 [‘추상’,
          ‘격리’, ‘거리두기’, ‘아동’, ‘성당’, ‘언론’, ‘흑백’] 등의 단어를
          조합하여 프롬프팅한 이미지를 극 중에서 활용하였습니다. 본 과정을 통해
          프롬프팅을 넘어, 인공지능의 원리에 대해 이해하고, 인공지능을 무대
          장치화할 수 있는 기술적 능력을 습득하기 위해 인공지능 교육과정을
          수강하였습니다.
        </div>
      </PageLeftSection>
      <PageRightSection>
